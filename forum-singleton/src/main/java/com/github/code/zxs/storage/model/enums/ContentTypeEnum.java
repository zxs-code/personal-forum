...
public enum ContentTypeEnum {
   ...
   /* CHM("CHM", "49545346030000006000"),
     ...
     * @return
     */
    public static ContentTypeEnum getByMagicNumberCode(String magicNumberCode) {
     ...
     * 根据文件类型后缀名获取枚举
     *
     * @param suffix - 文件类型后缀名
     * @return
     */
    public static ContentTypeEnum getByFileTypeName(String suffix) {
