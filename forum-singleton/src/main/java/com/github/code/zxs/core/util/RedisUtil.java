...
public class RedisUtil {
     ...
     * @return 对应的多个键值
     */
    public List<Map<String, Object>> hMultiEntries(List<String> keys) {
        ...
        List<Map<String, Object>> result = list.stream().map(m -> (Map<String, Object>) m).collect(Collectors.toList());
        return result;
    }
     ...
     * @return
     */
    public Boolean zAddWithDate(String key, Object value, long score) {
        try {
    ...
    public Boolean zAddWithDate(String key, Object value, int score, Date date) {
        try {
     ...
     * @return
     */
    public List<Long> zMultiSize(List<String> keys) {
        try {
